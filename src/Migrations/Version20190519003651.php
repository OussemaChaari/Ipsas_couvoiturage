 ...
 */
final class Version20190519003651 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE trajet (id INT AUTO_INCREMENT NOT NULL, ville_dep VARCHAR(255) NOT NULL, ville_arrivee VARCHAR(255) NOT NULL, date_dep DATE NOT NULL, heure_dep TIME NOT NULL, place_libres INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE trajet_voiture (trajet_id INT NOT NULL, voiture_id INT NOT NULL, INDEX IDX_9B55807BD12A823 (trajet_id), INDEX IDX_9B55807B181A8BA (voiture_id), PRIMARY KEY(trajet_id, voiture_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE trajet_voiture ADD CONSTRAINT FK_9B55807BD12A823 FOREIGN KEY (trajet_id) REFERENCES trajet (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE trajet_voiture ADD CONSTRAINT FK_9B55807B181A8BA FOREIGN KEY (voiture_id) REFERENCES voiture (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trajet_voiture DROP FOREIGN KEY FK_9B55807BD12A823');
        $this->addSql('ALTER TABLE trajet_voiture DROP FOREIGN KEY FK_9B55807B181A8BA');
        $this->addSql('DROP TABLE chauffeur');
        $this->addSql('DROP TABLE passager');
        $this->addSql('DROP TABLE reservation');
        $this->addSql('DROP TABLE trajet');
        $this->addSql('DROP TABLE trajet_voiture');
